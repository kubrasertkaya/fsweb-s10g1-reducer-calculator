...
import { addOne,changeOperation, applyNumber, CE,MEMORY_CLEAR,MEMORY_RECORD,MEMORY_PLUS } from './actions';
        ...
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              ...
              <CalcButton onClick={()=>dispatch({type:MEMORY_RECORD})} value={"MR"} />
